...
"[project]/Downloads/task-manager-web-app/lib/query-client.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function QueryProvider({ children }) {
    ...
    const [queryClient] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$task$2d$manager$2d$web$2d$app$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_$40$opentelemetry$2b$_162ef2eee2977cfe0d3476575909914c$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "QueryProvider.useState": ()=>new __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$task$2d$manager$2d$web$2d$app$2f$node_modules$2f2e$pnpm$2f40$tanstack$2b$query$2d$core$40$5$2e$90$2e$11$2f$node_modules$2f40$tanstack$2f$query$2d$core$2f$build$2f$modern$2f$queryClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["QueryClient"]({
                defaultOptions: {
                    queries: {
                        staleTime: 60 * 1000,
                        retry: 3,
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$task$2d$manager$2d$web$2d$app$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_$40$opentelemetry$2b$_162ef2eee2977cfe0d3476575909914c$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$task$2d$manager$2d$web$2d$app$2f$node_modules$2f2e$pnpm$2f40$tanstack$2b$react$2d$query$40$5$2e$90$2e$11_react$40$19$2e$2$2e$0$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$QueryClientProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["QueryClientProvider"], {
        client: queryClient,
        children: children
    }, void 0, false, {
...
"[project]/Downloads/task-manager-web-app/lib/api-client.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/Downloads/task-manager-web-app/lib/store.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const useAuthStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$task$2d$manager$2d$web$2d$app$2f$node_modules$2f2e$pnpm$2f$zustand$40$5$2e$0$2e$8_$40$types$2b$react$40$_e0de22dce18d7b8b0318449e26ad2c3f$2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])()((0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$task$2d$manager$2d$web$2d$app$2f$node_modules$2f2e$pnpm$2f$zustand$40$5$2e$0$2e$8_$40$types$2b$react$40$_e0de22dce18d7b8b0318449e26ad2c3f$2f$node_modules$2f$zustand$2f$esm$2f$middleware$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["persist"])((set, get)=>({
        ...
        login: async (email, password)=>{
            ...
            try {
                const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$task$2d$manager$2d$web$2d$app$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].post("/api/auth/login", {
                    email,
                    password
                }, {
                    skipAuth: true
                });
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$task$2d$manager$2d$web$2d$app$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setTokens"])(data.access_token, data.refresh_token);
                const user = {
                    id: data.user.id,
        ...
        loginWithGoogle: ()=>{
            ...
            window.location.href = `${__TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$task$2d$manager$2d$web$2d$app$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_BASE_URL"]}/api/auth/google`;
        },
        signup: async (username, email, password)=>{
            ...
            try {
                const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$task$2d$manager$2d$web$2d$app$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].post("/api/auth/register", {
                    username,
                    email,
                    password
                }, {
        ...
        logout: async ()=>{
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$task$2d$manager$2d$web$2d$app$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].post("/api/auth/logout");
            } catch (error) {
                console.error("[Auth] Logout error:", error);
            } finally{
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$task$2d$manager$2d$web$2d$app$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clearTokens"])();
                set({
                    user: null,
                    isAuthenticated: false
                });
                __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$task$2d$manager$2d$web$2d$app$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].clearCache();
            }
        },
        refreshToken: async ()=>{
            try {
                const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$task$2d$manager$2d$web$2d$app$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].post("/api/auth/refresh");
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$task$2d$manager$2d$web$2d$app$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setTokens"])(data.access_token, data.refresh_token);
                return true;
            } catch  {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$task$2d$manager$2d$web$2d$app$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clearTokens"])();
...
const useTaskStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$task$2d$manager$2d$web$2d$app$2f$node_modules$2f2e$pnpm$2f$zustand$40$5$2e$0$2e$8_$40$types$2b$react$40$_e0de22dce18d7b8b0318449e26ad2c3f$2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])()((set, get)=>({
        ...
        createTask: async (taskData)=>{
            ...
            try {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$task$2d$manager$2d$web$2d$app$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].invalidateCache("/api/tasks");
                return data;
            } catch (error) {
...
const useChatStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$task$2d$manager$2d$web$2d$app$2f$node_modules$2f2e$pnpm$2f$zustand$40$5$2e$0$2e$8_$40$types$2b$react$40$_e0de22dce18d7b8b0318449e26ad2c3f$2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])()((set, get)=>({
        ...
        fetchMessages: async (otherUserId)=>{
            ...
            try {
                const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$task$2d$manager$2d$web$2d$app$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].get(`/api/messages/conversations/${otherUserId}`);
                set({
                    messages: data,
                    isLoading: false
                });
...
const useNotificationStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$task$2d$manager$2d$web$2d$app$2f$node_modules$2f2e$pnpm$2f$zustand$40$5$2e$0$2e$8_$40$types$2b$react$40$_e0de22dce18d7b8b0318449e26ad2c3f$2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])()((set, get)=>({
        ...
        subscribeToNotifications: ()=>{
            ...
            const eventSource = new EventSource(`${__TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$task$2d$manager$2d$web$2d$app$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_BASE_URL"]}/api/notifications/stream?token=${token}`);
            ...
            eventSource.onerror = ()=>{
                ...
                setTimeout(()=>{
                    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$task$2d$manager$2d$web$2d$app$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAccessToken"])()) {
...
"[project]/Downloads/task-manager-web-app/components/providers.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$task$2d$manager$2d$web$2d$app$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_$40$opentelemetry$2b$_162ef2eee2977cfe0d3476575909914c$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Downloads/task-manager-web-app/node_modules/.pnpm/next@16.0.3_@opentelemetry+_162ef2eee2977cfe0d3476575909914c/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$task$2d$manager$2d$web$2d$app$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_$40$opentelemetry$2b$_162ef2eee2977cfe0d3476575909914c$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Downloads/task-manager-web-app/node_modules/.pnpm/next@16.0.3_@opentelemetry+_162ef2eee2977cfe0d3476575909914c/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$task$2d$manager$2d$web$2d$app$2f$lib$2f$query$2d$client$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Downloads/task-manager-web-app/lib/query-client.tsx [app-client] (ecmascript)");
...
function ThemeProvider({ children }) {
    _s();
    const { theme } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$task$2d$manager$2d$web$2d$app$2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUIStore"])();
...
function Providers({ children }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$task$2d$manager$2d$web$2d$app$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_$40$opentelemetry$2b$_162ef2eee2977cfe0d3476575909914c$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$task$2d$manager$2d$web$2d$app$2f$lib$2f$query$2d$client$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["QueryProvider"], {
...
//# sourceMappingURL=Downloads_task-manager-web-app_e7f4e43e._.js.map